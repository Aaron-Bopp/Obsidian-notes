...
const DEFAULT_SETTINGS = {
    preset: {
        ...
        statusBarAltQuery: "{files} files {total_words} words {total_characters} characters",
    },
    statusBarQuery: "{word_count} words {character_count} characters",
    statusBarAltQuery: "{files} files {total_words} words {total_characters} characters",
    countComments: false,
...
class BarManager {
    ...
    async updateStatusBar(text) {
        let newText = "";
        const expression = parse(this.settings.statusBarQuery);
...
class BetterWordCount extends obsidian.Plugin {
    ...
    async onload() {
        ...
        if (this.settings.collectStats) {
            this.registerEvent(this.app.workspace.on("quick-preview", this.dataManager.change, this.dataManager));
