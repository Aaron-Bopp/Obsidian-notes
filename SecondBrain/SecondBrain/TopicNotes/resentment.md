...
##### [[resentment]] `=length(this.file.inlinks) + length(this.file.outlinks)`


**Status**:: #EVER/SEED 
**Related-Topics**:: modification date: Wednesday 11th August 2021 17:50:36

**Last Edited**:: *`=this.file.mtime`*
##### [[resentment]] `=length(this.file.inlinks)` 
- 
