...
---
##### [[The Politicization of the Christian Church]] `=length(this.file.inlinks) + length(this.file.outlinks)`
...
##### [[The Politicization of the Christian Church]] `=length(this.file.inlinks)` 
- [[Non-faith issues have been co-opted to keep people in the christian church]]
