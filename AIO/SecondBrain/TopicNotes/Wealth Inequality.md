...
##### [[Wealth Inequality]] `=length(this.file.inlinks) + length(this.file.outlinks)`


**Status**:: #EVER/SEED 
**Related-Topics**:: [[Capitalism]], [[Marxism]], [[Communism]]
**Last Edited**:: *`=this.file.mtime`*
##### [[Wealth Inequality]] `=length(this.file.inlinks)` 
